...
__all__ = [
    ...
    'DISPID_SLRemovePronunciation', 'SVP_2', 'eLEXTYPE_PRIVATE19',
    'SPVPRI_ALERT', 'DISPID_SPARecoResult', 'SPPS_LMA', 'SP_VISEME_9',
    'ISpRecoContext', 'DISPID_SVSRunningState', 'DISPID_SRGCommit',
    'eLEXTYPE_PRIVATE13', 'SPEVENTSOURCEINFO',
    'Speech_Max_Pron_Length', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTGSM610_11kHzMono', 'SBOPause', 'SPWF_SRENGINE', 'SASRun',
    'SpeechCategoryAudioOut', 'DISPID_SPPParent', 'DISPID_SFSClose',
    'SAFTGSM610_22kHzMono', 'SpPhoneConverter',
    'SWPKnownWordPronounceable', 'eLEXTYPE_PRIVATE6', 'ISpStream',
    'SRADynamic', 'DISPID_SRCEInterference',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPRuleNumberOfElements', 'SVP_19', 'SPEI_VOICE_CHANGE',
    'SDTDisplayText', 'SGDSInactive', 'DISPID_SRSAudioStatus',
    'SAFTGSM610_8kHzMono', 'SpeechRegistryLocalMachineRoot',
    'SPPHRASEPROPERTY', 'DISPID_SVEAudioLevel', 'DISPID_SBSWrite',
    'SRCS_Disabled', 'SPEI_RESERVED6', 'DISPID_SRRecognizer',
    'ISpeechAudioBufferInfo', 'SPCS_DISABLED', 'DISPID_SPAsItem',
    'SREPropertyNumChange', 'DISPID_SpeechRecoResultTimes',
    'SpStreamFormatConverter', 'SpeechWordPronounceable',
    'SRTEmulated', 'DISPID_SRProfile', 'DISPID_SRRTTickCount',
    'DISPID_SPIReplacements', 'SAFT48kHz16BitMono', 'SPSNotOverriden',
    'SPPS_SuppressWord', 'SpeechPropertyHighConfidenceThreshold',
    'SVF_Stressed', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPRuleParent', 'ISpeechGrammarRuleStateTransition',
    'STCInprocHandler', 'DISPID_SRCEHypothesis', 'DISPID_SOTCSetId',
    'SVPNormal', 'SPRST_NUM_STATES', 'SAFT48kHz8BitStereo',
    'tagSTATSTG', 'ISpeechWaveFormatEx', 'DISPID_SGRClear',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpRecoCategory', 'SDTAll',
    'DISPID_SGRsCount', 'DISPID_SpeechPhraseProperties',
    'SPPS_Unknown', 'DISPID_SAEventHandle', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPACommit', 'DISPID_SPPsItem',
    'DISPID_SpeechRecoResult', 'SpeechPartOfSpeech', 'DISPID_SBSSeek',
    'DISPID_SLPsItem', 'DISPID_SVSLastBookmark', 'ISpeechDataKey',
    'SAFT44kHz8BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVESentenceBoundary',
    'SVSFIsNotXML', 'ISpeechCustomStream', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpCompressedLexicon', 'SRESoundEnd',
    'SpeechPropertyComplexResponseSpeed', 'SAFT32kHz16BitMono',
    'SPPS_Interjection', 'DISPID_SWFEBlockAlign',
    'SAFT11kHz8BitStereo', 'SPPHRASE', 'SGRSTTWildcard',
    'SPCATEGORYTYPE', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSTsItem', 'SpeechAudioFormatGUIDText',
    'SPWORDPRONUNCIATIONLIST', '_ISpeechRecoContextEvents', 'SLTApp',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVPause', '_SPAUDIOSTATE',
    'SVSFNLPSpeakPunc', 'DISPID_SLWPronunciations',
    'DISPID_SRRSpeakAudio', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SSSPTRelativeToStart', 'DISPID_SRDisplayUI',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechXMLRecoResult', 'SPWF_INPUT', 'SVP_10',
    'DISPID_SWFEChannels', 'ISpEventSource',
    'DISPID_SpeechRecognizerStatus', 'ISpStreamFormat',
    'SPVOICESTATUS', 'ISpeechPhraseElements', 'SAFT32kHz8BitMono',
    'SpeechVoiceEvents', 'SDTAlternates', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_18', 'SpeechEngineConfidence', 'SAFT44kHz16BitStereo',
    'ISpeechPhraseReplacement', 'ISequentialStream',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SADefaultFormat',
    'SSTTDictation', 'DISPID_SLWType', 'SPAS_PAUSE', 'SVEPrivate',
    'SPSTREAMFORMATTYPE', 'ISpDataKey', 'SPEI_RECOGNITION',
    'DISPIDSPTSI_SelectionOffset', 'SpeechGrammarTagWildcard',
    'DISPID_SVEPhoneme', 'DISPID_SDKGetBinaryValue',
    'DISPID_SWFEExtraData', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPRuleId', 'DISPID_SpeechFileStream', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPCLangId', 'IInternetSecurityMgrSite',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechLexiconProns',
    'SPRST_ACTIVE', 'SAFT12kHz8BitStereo', 'ISpeechPhraseAlternate',
    'SRERecoOtherContext', 'SpeechInterference', 'DISPIDSPTSI',
    'DISPID_SRAudioInput', 'DISPID_SRCESoundStart', 'SRSEDone',
    'DISPID_SPEsCount', 'SRAExport', 'SAFT48kHz8BitMono',
    ...
    'DISPID_SGRSTText', 'STSF_LocalAppData', '__MIDL_IWinTypes_0009',
    'DISPID_SLAddPronunciation', 'DISPID_SPAStartElementInResult',
    'WAVEFORMATEX', 'eLEXTYPE_RESERVED4', 'SVP_14',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPEDisplayText', 'SGRSTTEpsilon',
    'SVEAllEvents', 'SPSHT_NotOverriden', 'SDKLLocalMachine',
    'SINoSignal', 'DISPID_SRCCreateGrammar', 'DISPID_SRCERequestUI',
    'DISPID_SPRules_NewEnum', 'SP_VISEME_7',
    'DISPID_SPERetainedStreamOffset', 'SDTReplacement',
    'SDKLDefaultLocation', 'SPSModifier', 'DISPID_SVSInputWordLength',
    'SVSFIsFilename', 'SPWORD', 'DISPID_SPIGetDisplayAttributes',
    'SPSHT_Unknown', 'SpMMAudioOut', 'SAFT22kHz8BitMono', 'SLTUser',
    'SpeechWordType', 'SPVPRI_NORMAL', 'SECLowConfidence',
    'SREAdaptation', 'ISpeechRecoResultTimes', 'DISPID_SRGRules',
    'SP_VISEME_0', 'DISPID_SPCIdToPhone', 'SpObjectTokenCategory',
    'SVPOver', 'DISPID_SOTsItem', 'eLEXTYPE_PRIVATE17',
    'SPXMLRESULTOPTIONS', 'SP_VISEME_3', 'ISpeechGrammarRules',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRuleAttributes',
    'SPEI_START_INPUT_STREAM', 'SPEI_MAX_TTS', 'SPINTERFERENCE_NONE',
    'DISPID_SGRSTsCount', 'DISPID_SpeechGrammarRule',
    'DISPID_SVVolume', 'SpStream', 'SpeechRecoEvents',
    ...
    'DISPID_SPEAudioSizeTime', 'SGDSActiveWithAutoPause',
    'DISPID_SPAPhraseInfo', 'DISPID_SRGDictationLoad', 'SWTDeleted',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRSClsidEngine',
    'SGLexicalNoSpecialChars', 'ISpeechRecognizerStatus',
    'SAFT32kHz16BitStereo', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SABufferInfo', 'SPDKL_LocalMachine', 'SASStop',
    'DISPID_SRCPause', 'SPSHORTCUTTYPE', 'SPPS_RESERVED4',
    'SREPropertyStringChange', 'DISPID_SVEEnginePrivate',
    'DISPID_SDKGetlongValue', 'DISPID_SVSInputSentencePosition',
    'tagSPTEXTSELECTIONINFO', 'SPEI_SOUND_END',
    'DISPID_SRRSaveToMemory', 'SpNullPhoneConverter',
    'SPWT_PRONUNCIATION', 'SpeechFormatType', 'SAFTADPCM_22kHzMono',
    'SVEBookmark', 'SREInterference', 'DISPID_SpeechMMSysAudio',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechDisplayAttributes',
    'SPEI_SOUND_START', 'SPVISEMES', 'DISPID_SDKGetStringValue',
    'SpeechBookmarkOptions', 'DISPID_SpeechObjectTokens',
    'DISPID_SGRs_NewEnum', 'SRADefaultToActive', 'ISpPhraseAlt',
    'DISPID_SVRate', 'DISPID_SLWLangId', 'STCLocalServer',
    'DISPID_SVGetVoices', 'ISpeechAudioFormat',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechBaseStream',
    'DISPID_SVAlertBoundary', 'DISPID_SRState', 'DISPID_SpeechVoice',
    'DISPID_SpeechPhraseRule', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPIDSPRG', 'DISPID_SpeechLexiconPronunciation', 'SVP_9',
    'DISPID_SRSetPropertyString', 'SpeechCategoryAudioIn',
    'STSF_FlagCreate', 'DISPID_SLGetGenerationChange', 'SPAS_RUN',
    'ISpeechFileStream', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechPhraseRules', 'SpeechRecoContextState',
    'SpMemoryStream', 'SPCT_SLEEP', 'DISPID_SRGCmdSetRuleState',
    'SRTStandard', 'eLEXTYPE_PRIVATE15', 'SPEI_MIN_SR',
    'DISPID_SGRAddState', 'SpObjectToken', 'ISpeechAudioStatus',
    'ISpeechPhraseRules', 'SLODynamic', 'ISpRecoContext2',
    'SPPS_Function', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPGRAMMARWORDTYPE', 'SVEStartInputStream', 'SPPS_RESERVED2',
    'DISPID_SpeechRecoContext', 'ISpeechLexiconWord',
    'eLEXTYPE_PRIVATE18', 'SP_VISEME_15', 'DISPID_SRCRequestedUIType',
    'SpeechDataKeyLocation', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_USER', 'DISPID_SBSFormat', 'Speech_StreamPos_RealTime',
    'SVP_15', 'eLEXTYPE_MORPHOLOGY', 'SPWT_DISPLAY',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPPsCount', 'ISpeechGrammarRuleState', 'DISPID_SLWWord',
    'DISPID_SRGetPropertyString', 'DISPID_SDKEnumKeys', 'SPAR_High',
    'SDTPronunciation', 'DISPID_SOTGetStorageFileName',
    'SpeechEngineProperties', 'tagSPPROPERTYINFO',
    'ISpeechRecoContext', 'DISPID_SABIMinNotification',
    'SECFIgnoreWidth', 'SAFT44kHz16BitMono',
    'DISPID_SRCRetainedAudio', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPIEngineId', 'SpeechAudioProperties',
    'DISPID_SRGDictationSetState', 'DISPID_SVResume',
    'SpeechCategoryAppLexicons', 'SDA_One_Trailing_Space',
    'SVSFlagsAsync', 'ISpeechPhraseElement', 'SAFT32kHz8BitStereo',
    'SPSHT_OTHER', 'SpeechDiscardType', 'DISPID_SpeechWaveFormatEx',
    'SGDSActiveUserDelimited', 'Speech_Default_Weight', 'SPBO_AHEAD',
    'SSFMCreateForWrite', 'SpPhoneticAlphabetConverter', 'SpShortcut',
    'SpInProcRecoContext', 'DISPID_SVSkip', 'SPBO_PAUSE', 'SITooSlow',
    'ISpeechLexiconWords', 'DISPID_SRCEStartStream',
    'DISPID_SVSPhonemeId', 'SREStreamStart',
    'ISpeechTextSelectionInformation',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SPRuleName',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechRecoResult2',
    'SPAO_NONE', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SRCEPropertyStringChange', 'ISpeechGrammarRule',
    'DISPID_SpeechPhraseAlternate', 'SpAudioFormat',
    'ISpeechRecoResultDispatch', 'DISPID_SPRNumberOfElements',
    'DISPID_SPRulesItem', 'SAFTADPCM_44kHzMono',
    'DISPID_SRCEventInterests', 'SGDSActive', 'SVSFParseSsml',
    'DISPID_SPPEngineConfidence', 'SAFT22kHz16BitMono',
    'DISPID_SGRSTPropertyName', 'DISPID_SLPPartOfSpeech',
    'SREAudioLevel', 'DISPID_SPIAudioSizeTime', 'SDTRule',
    'ISpNotifyTranslator', 'DISPID_SRRGetXMLErrorInfo',
    'SAFT44kHz8BitStereo', 'DISPID_SDKDeleteKey',
    'SpeechVoiceSkipTypeSentence', 'SVP_5', 'SDKLCurrentUser',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCEFalseRecognition',
    'SPEI_START_SR_STREAM', 'STCAll', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPELexicalForm', 'ISpMMSysAudio',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRSetPropertyNumber',
    'SRTSMLTimeout', 'SpeechRegistryUserRoot', 'SpPhraseInfoBuilder',
    'DISPID_SGRSTPropertyId', 'SPEVENT',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTDisplayUI', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eWORDTYPE_DELETED', 'ISpShortcut',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT12kHz16BitMono', 'SREPrivate', 'DISPID_SGRId',
    'DISPID_SRCRecognizer', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_PRIVATE11', 'SREBookmark', 'DISPID_SRCEPhraseStart',
    'SPAUDIOSTATUS', 'SPCT_DICTATION', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRuleEngineConfidence', 'SPPROPERTYINFO', 'SSTTWildcard',
    'DISPID_SVEStreamStart', 'SpLexicon', 'DISPID_SpeechAudioFormat',
    'DISPID_SVSInputSentenceLength', 'SGDisplay',
    'DISPID_SOTGetAttribute', 'SAFT24kHz8BitMono', 'DISPID_SAVolume',
    'DISPID_SpeechDataKey', 'SVP_1', 'SVEWordBoundary',
    'SpeechCategoryVoices', 'DISPID_SpeechPhoneConverter',
    'SGRSTTRule', 'SP_VISEME_5', 'SpeechAudioFormatGUIDWave',
    'SAFT11kHz16BitMono', 'SECFNoSpecialChars', 'SPSMF_UPS',
    'SREHypothesis', 'SAFTCCITT_uLaw_22kHzMono', 'SPPHRASERULE',
    'SPWT_LEXICAL', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SWFEBitsPerSample', 'SPGS_ENABLED', 'SPFM_CREATE_ALWAYS',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechObjectTokenCategory', 'SGRSTTTextBuffer', 'SVP_7',
    'DISPID_SRGCmdLoadFromResource', 'ISpRecoGrammar',
    'SpWaveFormatEx', 'SVF_Emphasis', 'DISPID_SOTIsUISupported',
    'DISPID_SPRText', 'SpMMAudioIn', 'DISPID_SOTCGetDataKey',
    'SpeechCategoryRecognizers', 'ISpeechObjectToken',
    'SRSEIsSpeaking', 'DISPID_SVSLastResult', 'DISPID_SLWsCount',
    'SPRULESTATE', 'SPCT_SUB_COMMAND', 'SPAO_RETAIN_AUDIO',
    'SAFT11kHz8BitMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SSFMCreate',
    'DISPID_SMSGetData', 'SPRECOCONTEXTSTATUS',
    'ISpeechPhraseProperty', 'SPPARTOFSPEECH',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPFM_CREATE',
    'SpFileStream', 'DISPID_SRIsUISupported', 'SpeechUserTraining',
    'ISpVoice', 'DISPID_SOTCEnumerateTokens',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPIGrammarId',
    'DISPID_SFSOpen', 'DISPID_SVEWord', 'ISpLexicon',
    'SPSEMANTICERRORINFO', 'DISPID_SBSRead',
    'DISPID_SpeechPhraseElement', 'DISPID_SVEStreamEnd',
    'DISPID_SLGenerationId', 'DISPID_SpeechGrammarRules',
    'DISPID_SPEAudioTimeOffset', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVAudioOutputStream', 'DISPID_SPEDisplayAttributes',
    'DISPID_SGRSTType', 'DISPID_SPRsItem', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_19', 'DISPID_SGRSTWeight',
    'SPEI_PHONEME', 'SVP_6', 'SPWORDLIST',
    'DISPID_SRGSetTextSelection', 'SAFT16kHz16BitStereo',
    'SP_VISEME_6', 'SPINTERFERENCE_TOOLOUD', 'SAFTText', 'SPFILEMODE',
    'DISPID_SPRs_NewEnum', 'SPPS_RESERVED1',
    'SpeechStreamSeekPositionType', 'SAFT8kHz8BitMono', 'SGSEnabled',
    'DISPID_SRCERecognizerStateChange', 'SpeechVoicePriority',
    'SPXRO_Alternates_SML', 'SAFTCCITT_uLaw_11kHzMono',
    'SPGS_EXCLUSIVE', 'DISPID_SPCPhoneToId', '_ISpeechVoiceEvents',
    'DISPID_SVAudioOutput', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRPhraseInfo', 'UINT_PTR', 'SPEVENTENUM', 'SVP_20',
    'SPEI_WORD_BOUNDARY', 'ISpeechObjectTokens', 'SPPS_RESERVED3',
    'DISPID_SRCVoice', 'ISpObjectToken', 'DISPID_SRRRecoContext',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_11', 'DISPID_SOTGetDescription',
    'SPPS_Modifier', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechTokenShellFolder', 'DISPID_SRRTLength', 'DISPID_SRRTimes',
    'SpeechLexiconType', 'DISPID_SLPsCount', 'SPEI_INTERFERENCE',
    'DISPID_SASNonBlockingIO', 'SpMMAudioEnum', 'ISpObjectWithToken',
    'SAFT8kHz16BitStereo', 'SPEI_RESERVED3', 'DISPID_SAFType',
    'ISpNotifySink', 'SpeechVisemeFeature',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechPhraseReplacements',
    'ISpEventSink', 'SpeechRecognizerState', 'SPEI_SENTENCE_BOUNDARY',
    'SPBO_NONE', 'IInternetSecurityManager', 'DISPID_SPPChildren',
    'DISPID_SPANumberOfElementsInResult', 'SRERequestUI',
    'DISPID_SGRSRule', 'SAFTDefault',
    'DISPID_SPPBRestorePhraseFromMemory', 'SGRSTTWord', 'SVP_11',
    'SLOStatic', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVSLastBookmarkId', 'ISpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SDKEnumValues', 'SDTAudio',
    'DISPID_SVEVoiceChange', 'DISPID_SPIGetText',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_2', 'ISpRecognizer2',
    'DISPID_SABIBufferSize', 'SRTAutopause', 'DISPID_SOTCId',
    'ISpRecoResult', 'DISPID_SRCEAdaptation', 'SpeechRunState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCESoundEnd',
    'ISpeechPhraseInfo', 'ISpXMLRecoResult', 'SREStateChange',
    'SPCONTEXTSTATE', 'SPDKL_DefaultLocation', 'DISPID_SLWs_NewEnum',
    'SpVoice', 'SAFTGSM610_44kHzMono', 'SASClosed', 'SSTTTextBuffer',
    'eLEXTYPE_PRIVATE2', 'ISpeechBaseStream',
    'SpeechTokenKeyAttributes', 'SRARoot',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SITooFast', 'DISPID_SPIRule',
    'SSFMOpenForRead', 'SVSFUnusedFlags',
    'DISPID_SpeechPhraseAlternates', 'SPLO_STATIC',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SDKDeleteValue',
    'IEnumSpObjectTokens', 'DISPID_SRGId', 'SPCS_ENABLED',
    'SpInprocRecognizer', 'SPRST_INACTIVE', 'eWORDTYPE_ADDED',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT11kHz16BitStereo',
    'SPAUDIOBUFFERINFO', 'SPTEXTSELECTIONINFO',
    'DISPID_SpeechLexiconWord', 'DISPID_SAFGetWaveFormatEx',
    'SVEEndInputStream', 'ISpeechPhraseAlternates', 'ISpeechLexicon',
    'SITooLoud', 'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVSpeakStream',
    'DISPID_SRCreateRecoContext', 'SPFM_NUM_MODES', 'DISPID_SVSpeak',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPEsItem',
    'SAFTCCITT_uLaw_22kHzStereo', 'SGPronounciation',
    'DISPID_SRCEEnginePrivate', 'SRTReSent', 'SAFT16kHz16BitMono',
    'DISPID_SGRSTransitions', 'SPEI_SR_PRIVATE',
    'SpeechTokenKeyFiles', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRRAlternates', 'DISPID_SVEBookmark',
    'ISpeechLexiconPronunciations', 'SRSInactive', 'SFTInput',
    'SpeechStreamFileMode', 'SVEPhoneme',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPEPronunciation',
    'DISPID_SPPConfidence', 'ISpeechLexiconPronunciation',
    'SPEI_RESERVED1', 'SpeechTokenContext', 'SAFTNonStandardFormat',
    'DISPID_SDKOpenKey', 'DISPID_SVStatus', 'DISPID_SRCEEndStream',
    'SPGRAMMARSTATE', 'SP_VISEME_20', 'DISPID_SPIStartTime',
    'ISpeechMemoryStream', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRCResume',
    'DISPID_SGRInitialState', 'DISPID_SpeechMemoryStream',
    'SPSERIALIZEDRESULT', 'SPRST_ACTIVE_ALWAYS', 'ISpResourceManager',
    'SPLO_DYNAMIC', 'DISPID_SVSVisemeId', 'DISPID_SPPs_NewEnum',
    'SPINTERFERENCE', 'SPSEMANTICFORMAT', 'SPAS_STOP',
    'SPRS_INACTIVE', 'SPSHT_EMAIL', 'ISpeechRecoResult',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPPFirstElement', 'SRAImport', 'SECFDefault',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SAFGuid',
    'SAFT12kHz8BitMono', 'SpSharedRecognizer', 'SAFTADPCM_8kHzMono',
    ...
    'DISPID_SRIsShared', 'DISPID_SRCState', 'DISPID_SPRuleChildren',
    'SAFT22kHz8BitStereo', 'DISPID_SRCERecognitionForOtherContext',
    'SPAUDIOOPTIONS', 'DISPID_SLPPhoneIds', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPPValue', 'DISPID_SPRulesCount', 'SPSMF_SAPI_PROPERTIES',
    'SpeechAudioFormatType', 'SECFEmulateResult',
    'SAFTNoAssignedFormat', 'ISpeechPhraseReplacements',
    'SPAR_Medium', 'SGSDisabled', 'SVESentenceBoundary',
    'SPWORDPRONOUNCEABLE', 'SpeechTokenValueCLSID',
    'DISPID_SpeechAudioStatus', 'DISPID_SRGetRecognizers',
    'DISPID_SREmulateRecognition', 'DISPID_SRRGetXMLResult',
    'DISPID_SDKCreateKey', 'SAFTADPCM_22kHzStereo',
    'SDA_No_Trailing_Space', 'DISPID_SpeechPhraseProperty',
    'SpeechVoiceCategoryTTSRate', 'SPBINARYGRAMMAR',
    'DISPID_SGRSTRule', 'DISPID_SDKSetStringValue', 'DISPID_SGRsAdd',
    'SPAS_CLOSED', 'SPWORDTYPE', 'SITooQuiet',
    'SpeechDictationTopicSpelling', 'SPINTERFERENCE_NOSIGNAL',
    'SP_VISEME_4', 'SRAORetainAudio', 'SPRS_ACTIVE',
    'ISpeechRecoGrammar', 'DISPID_SRRDiscardResultInfo', 'ISpPhrase',
    'SVF_None', '_RemotableHandle', 'SDA_Consume_Leading_Spaces',
    'SAFTADPCM_11kHzStereo', 'SpeechVisemeType', 'SPAUDIOSTATE',
    'DISPID_SPAsCount', 'SVP_16', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRCEBookmark', 'SPEI_HYPOTHESIS', 'SGLexical', 'LONG_PTR',
    'SVP_18', 'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPPId', 'SPSVerb',
    'DISPID_SpeechPhraseElements', 'SECHighConfidence',
    'DISPID_SPAs_NewEnum', 'DISPID_SRGRecoContext', 'SVSFIsXML',
    'SpResourceManager', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRGState', 'SAFT16kHz8BitStereo',
    'DISPID_SABufferNotifySize', 'SP_VISEME_10', 'ISpeechMMSysAudio',
    'SPCT_SUB_DICTATION', 'SPPS_Verb', 'DISPID_SRGIsPronounceable',
    'SINone', 'SVSFParseAutodetect', 'ISpProperties',
    'DISPID_SVPriority', 'SPVPRIORITY', 'DISPID_SRAudioInputStream',
    'SASPause', 'SP_VISEME_17', 'DISPID_SpeechCustomStream',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRsCommitAndSave',
    'SpCustomStream', 'eLEXTYPE_RESERVED6', 'SVEAudioLevel',
    'SRSActiveAlways', 'SVP_21', 'SPEI_END_SR_STREAM',
    ...
    'SAFT48kHz16BitStereo', 'SAFTExtendedAudioFormat',
    'SpeechRuleState', 'ISpeechObjectTokenCategory', 'ISpRecognizer3',
    'eLEXTYPE_PRIVATE12', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SCSBaseStream', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRFirstElement', 'SPDATAKEYLOCATION',
    'eLEXTYPE_RESERVED10', 'DISPID_SPEs_NewEnum',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRsFindRule',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechSpecialTransitionType', 'DISPID_SGRsDynamic',
    'DISPID_SVIsUISupported', 'SAFTCCITT_ALaw_44kHzMono',
    'SPRECOSTATE', 'SSFMOpenReadWrite', 'SRESoundStart',
    'DISPID_SVSCurrentStreamNumber', 'STSF_AppData',
    'SAFT16kHz8BitMono', 'SpNotifyTranslator',
    'DISPID_SAFSetWaveFormatEx', 'SPAR_Low',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE20', 'DISPID_SpeechVoiceEvent',
    'SPPHRASEREPLACEMENT', 'DISPID_SPIEnginePrivateData',
    'Speech_Max_Word_Length', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_21',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SWFESamplesPerSec',
    'SAFT22kHz16BitStereo', 'ISpeechVoiceStatus',
    'DISPID_SpeechLexicon', 'DISPID_SRCRetainedAudioFormat',
    'eLEXTYPE_RESERVED9', 'eLEXTYPE_PRIVATE8', 'SVSFDefault',
    'DISPID_SMSSetData', 'DISPID_SLGetWords', 'SPSNoun',
    'ISpeechRecognizer', 'DISPID_SOTRemove', 'SAFT8kHz16BitMono',
    'SPINTERFERENCE_NOISE', 'DISPID_SPISaveToMemory', 'SDTProperty',
    'SPEI_REQUEST_UI', 'DISPID_SVVoice', 'IStream',
    'DISPID_SRCCmdMaxAlternates', 'SpeechRecognitionType',
    'DISPID_SMSALineId', 'SPSInterjection', 'DISPID_SGRAttributes',
    'ISpGrammarBuilder', 'DISPID_SRGDictationUnload',
    'DISPID_SRRAudio', 'SREStreamEnd', 'DISPID_SPEEngineConfidence',
    'SRATopLevel', 'SVP_17', 'SREAllEvents', 'Speech_StreamPos_Asap',
    'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE16',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKSetBinaryValue',
    'SPLEXICONTYPE', 'DISPID_SpeechAudio',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVEViseme',
    'DISPID_SpeechLexiconWords', 'SVSFParseMask',
    'SpeechPropertyResourceUsage', 'SAFT24kHz16BitMono',
    'SPEI_RESERVED2', 'ISpeechPhraseProperties', 'SPXRO_SML',
    'SpeechRetainedAudioOptions', 'DISPID_SVGetAudioOutputs',
    'SPBOOKMARKOPTIONS', 'DISPID_SGRSAddWordTransition',
    'DISPID_SOTsCount', 'SECFIgnoreKanaType',
    'SpTextSelectionInformation', 'SVEVoiceChange',
    'ISpeechPhraseRule', 'SPEI_SR_BOOKMARK',
    'DISPID_SPRuleConfidence', 'DISPID_SVSInputWordPosition',
    'SpeechTokenIdUserLexicon', 'DISPID_SLPs_NewEnum',
    'SPPHRASEELEMENT', 'SVP_3', 'DISPID_SPRuleFirstElement',
    'SPSERIALIZEDPHRASE', 'SpeechGrammarWordType',
    'DISPID_SGRsCommit', 'DISPID_SLPLangId', 'SVP_12',
    'DISPID_SOTSetId', 'SVSFNLPMask', 'SpeechCategoryRecoProfiles',
    'SGRSTTDictation', 'SpeechGrammarTagDictation',
    'DISPIDSPTSI_SelectionLength', 'SVP_8', 'SVSFPersistXML',
    'DISPID_SLWsItem', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGCmdLoadFromFile', 'SAFT24kHz8BitStereo',
    'SECFIgnoreCase', 'SINoise', 'DISPID_SRGetFormat',
    'DISPID_SWFEFormatTag', 'SPBO_TIME_UNITS', 'ISpeechVoice',
    'SPSLMA', 'SPWORDPRONUNCIATION', 'DISPID_SVSpeakCompleteEvent',
    'SAFTADPCM_11kHzMono', 'ISpeechRecoResult2', 'SPEI_TTS_PRIVATE',
    'STSF_CommonAppData', 'DISPID_SGRSTs_NewEnum',
    'ISpeechResourceLoader', 'SpeechPropertyResponseSpeed',
    'DISPID_SPILanguageId', 'SPSSuppressWord',
    'ISpeechPhoneConverter', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechObjectToken', 'DISPID_SOTRemoveStorageFileName',
    'ISpRecoGrammar2', 'SPSFunction', 'SRSActive',
    'SpeechVoiceSpeakFlags', 'DISPID_SRCAudioInInterferenceStatus',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechAddRemoveWord',
    'DISPID_SRRAudioFormat', 'DISPID_SpeechRecognizer',
    'DISPID_SOTId', 'DISPID_SRCBookmark',
    'DISPID_SPEActualConfidence', 'SpeechAudioState',
    'SPFM_OPEN_READONLY', 'SSSPTRelativeToEnd',
    'ISpObjectTokenCategory', 'ISpSerializeState', 'DISPID_SGRsItem',
    'DISPID_SOTDataKey', 'DISPID_SRGReset', 'SVSFVoiceMask',
    'SPEI_MAX_SR', 'SpeechMicTraining', 'DISPID_SVGetProfiles',
    'SVP_4', 'DISPID_SPRsCount', 'SRCS_Enabled', 'SPVPRI_OVER',
    'DISPID_SOTCDefault', 'SpUnCompressedLexicon',
    'eLEXTYPE_RESERVED8', 'SAFT8kHz8BitStereo', 'SP_VISEME_8',
    'SP_VISEME_12', 'SpeechAllElements', 'SPEI_UNDEFINED',
    'SPAR_Unknown', 'SPADAPTATIONRELEVANCE', 'DISPID_SRRTStreamTime',
    'SP_VISEME_1', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechPhraseInfo',
    'DISPID_SOTCreateInstance', 'DISPID_SASCurrentSeekPosition',
    'ISpAudio', 'SVP_0', 'SPPS_Noncontent', 'SDA_Two_Trailing_Spaces',
    'SDKLCurrentConfig', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SMSADeviceId', 'DISPID_SMSAMMHandle', 'SpeechAudioVolume',
    'DISPID_SpeechVoiceStatus', 'STCInprocServer', 'DISPID_SRStatus',
    'SVEViseme', 'DISPID_SGRSTNextState', 'SAFT12kHz16BitStereo',
    'SAFTADPCM_44kHzStereo', 'ISpNotifySource', 'SPEI_PHRASE_START',
    'ISpPhoneConverter', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyAdaptationOn', 'SPSUnknown', 'SpeechLoadOption',
    'STCRemoteServer', 'SREFalseRecognition', 'IEnumString',
    'SPEI_MIN_TTS', 'SP_VISEME_14',
    'SpeechGrammarTagUnlimitedDictation', 'SPINTERFERENCE_TOOSLOW',
    'SPPS_Noun', 'SAFT24kHz16BitStereo', 'SRAInterpreter',
    'DISPID_SRCERecognition', 'SpeechEmulationCompareFlags', 'SPRULE',
    'DISPID_SLPSymbolic', 'SP_VISEME_13', 'DISPID_SLPType',
    'SPFM_OPEN_READWRITE', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SABIEventBias', 'SVSFParseSapi', 'DISPID_SGRAddResource',
    'DISPID_SPIAudioStreamPosition', 'SPSHORTCUTPAIR', 'ISpeechAudio',
    'DISPID_SASetState', 'SAFTCCITT_ALaw_8kHzMono', 'SFTSREngine',
    'ISpRecognizer', 'SPWAVEFORMATTYPE', 'DISPID_SPPName',
    'SPPS_NotOverriden', 'SRERecognition', 'DISPID_SASState',
    'SVPAlert', 'eLEXTYPE_PRIVATE10', 'SWTAdded',
    'SPDKL_CurrentConfig', 'DISPID_SOTCategory', 'SVP_13',
    'DISPID_SGRName', 'DISPID_SVDisplayUI', 'SPEI_ADAPTATION',
    'SGSExclusive', 'SpeechRecoProfileProperties',
    'DISPID_SRSNumberOfActiveRules', 'SpSharedRecoContext',
    'eLEXTYPE_RESERVED7', 'SREPhraseStart', 'SP_VISEME_16',
    'ISpStreamFormatConverter', 'DISPID_SLGetPronunciations',
    'SPEI_VISEME', 'SPLOADOPTIONS', 'SRAONone', 'SpeechTokenKeyUI',
    'SRTExtendableParse', 'SBONone'
]
